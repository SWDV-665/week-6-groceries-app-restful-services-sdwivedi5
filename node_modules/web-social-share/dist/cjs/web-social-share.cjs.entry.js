...
const index = require('./index-8efb77d9.js');
...
const WebSocialShare = class {
  ...
  render() {
    return (index.h("div", { class: this.show
        ? 'web-social-share web-social-share-open'
        : 'web-social-share web-social-share-close', ref: (el) => (this.refContainer = el) }, index.h("div", { class: "web-social-share-backdrop", onClick: () => this.hide() }), index.h("div", { class: "web-social-share-action-sheet", onClick: () => this.hide() }, index.h("div", { class: "web-social-share-action-sheet-container" }, index.h("div", { class: "web-social-share-action-sheet-group" }, this.renderTargets())))));
  }
  renderTargets() {
    var _a;
